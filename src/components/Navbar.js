            ...
            >
                ...
                <nav className="p-4">
                    <ul className="space-y-4">
                        ...
                        <li>
                            <a className="text-gray-700 transition hover:text-gray-900" href="/upload">Upload</a>
                        </li>
                        <li>
                            <a className="text-gray-700 transition hover:text-gray-900" href="/about">About Us</a>
                        </li>
                        <li>
